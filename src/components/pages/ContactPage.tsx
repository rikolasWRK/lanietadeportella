  ...
  return (
    <main className="min-h-screen bg-primary-bg text-dark-chocolate">
      ...
      <section className="py-20 bg-dark-chocolate text-primary-bg text-center relative overflow-hidden">
        ...
        >
          Un lugar donde cada visita huele a mantequilla, cacao y hogar. Te
          esperamos en el corazón de Tarapoto.
        </motion.p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="space-y-5">
              ...
              return (
                ...
                >
                  <div className="shrink-0 w-10 h-10 bg-action-cta/10 group-hover:bg-action-cta/20 rounded-xl flex items-center justify-center transition-colors duration-300">
                    <Icon
                      className="w-4.5 h-4.5 text-action-cta"
                      strokeWidth={1.8}
                    />
                  </div>
            ...
            >
              <span className="font-sans text-xs font-light text-dark-chocolate/40">
                Síguenos:
              </span>
              <a
              ...
              >
                <Instagram className="w-3.5 h-3.5" />@{INSTAGRAM_USERNAME}
              </a>
            </motion.div>
          </div>
          ...
          >
            ...
            <div className="bg-dark-chocolate px-5 py-3 flex items-center gap-2.5">
              ...
              <div>
                <p className="font-sans text-xs font-bold text-primary-bg leading-none">
                  La Nieta de Portella
                </p>
                <p className="font-sans text-xs font-light text-primary-bg/50 mt-0.5">
                  Jr. Lamas 173, Tarapoto
                </p>
              </div>
            </div>
