...
import { ArrowLeft, Heart, Flame, Sparkles, BookOpen, Star } from "lucide-react";
...
export default function StoryPage() {
  ...
  const chapterStickers = [
    ...
    [
      { src: "sticker-i1.png", alt: "Sticker La Nieta", className: "top-[-10px] right-[25%] w-22 h-22 sm:w-26 sm:h-26", rotation: -10 },
      { src: "sticker-i3.png", alt: "Sticker Corazón", className: "top-[40%] right-[3%] w-18 h-18 sm:w-22 sm:h-22", rotation: 15 },
      { src: "sticker-i5.png", alt: "Sticker Tradición", className: "bottom-[-10px] right-[20%] w-20 h-20 sm:w-24 sm:h-24", rotation: -5 },
    ],
    // Chapter 1 (90s) - Text is on Right. Spacer on Left.
    [
      { src: "sticker-i2.png", alt: "Sticker Dulce", className: "top-[-10px] left-[25%] w-20 h-20 sm:w-24 sm:h-24", rotation: 12 },
      { src: "sticker-i4.png", alt: "Sticker Receta", className: "top-[40%] left-[3%] w-18 h-18 sm:w-22 sm:h-22", rotation: -12 },
      { src: "sticker-i6.png", alt: "Sticker Sello", className: "bottom-[-10px] left-[20%] w-20 h-20 sm:w-24 sm:h-24", rotation: -8 },
    ],
    // Chapter 2 (2011-2012) - Text is on Left. Spacer on Right.
    [
      { src: "sticker-i3.png", alt: "Sticker Detalle", className: "top-[-10px] right-[25%] w-20 h-20 sm:w-26 sm:h-26", rotation: -15 },
      { src: "sticker-coffee.png", alt: "Sticker Don Antonio", className: "top-[40%] right-[3%] w-20 h-20 sm:w-26 sm:h-26", rotation: -8 },
      { src: "sticker-cat-3pisos.png", alt: "Sticker Torta", className: "bottom-[-10px] right-[20%] w-24 h-24 sm:w-30 sm:h-30", rotation: 15 },
    ],
    // Chapter 3 (2014-Present) - Text is on Right. Spacer on Left.
    [
      { src: "sticker-i6.png", alt: "Sticker Insignia", className: "top-[-10px] left-[25%] w-20 h-20 sm:w-26 sm:h-26", rotation: 15 },
      { src: "sticker-i2.png", alt: "Sticker Dulzura", className: "top-[40%] left-[3%] w-18 h-18 sm:w-22 sm:h-22", rotation: -10 },
      { src: "sticker-i4.png", alt: "Sticker Secreto", className: "bottom-[-10px] left-[20%] w-20 h-20 sm:w-26 sm:h-26", rotation: 8 },
    ]
  ];
  ...
  const chapters = [
    {
      ...
      content: (
        <>
          La verdadera historia de La Nieta de Portella no empieza frente a un horno comercial, sino en los años 70, bajo la mirada atenta y cariñosa de la abuela Angela Portella. Angélica era su nieta engreída, esa pequeña que observaba fascinada cómo las manos sabias de su abuela transformaban ingredientes sencillos en momentos de pura felicidad. Creciendo además en el seno de una de las familias de panaderos más emblemáticas de Tarapoto —entre las décadas de los 60 y los 2000—, Angélica llevaba la harina, el calor del horno y el aroma del pan recién horneado corriendo por la sangre. Años más tarde, su esposo Juan Carlos se uniría a esta herencia, apoyando con devoción el taller de sus suegros.
        </>
      ),
    ...
    },
    {
      ...
      content: (
        <>
          La vida, sin embargo, traza caminos desafiantes. Durante las épocas más duras del país en medio de profundas movilizaciones extremistas y crisis familiares, el panorama se tornó adverso. Para recibir a su primer hijo, Juan Carlos (1993), Angélica y su esposo tuvieron que reinventarse por completo. Con un empuje indomable y sin temor al cansancio, ella vendía hamburguesas en un carrito típico afuera de los colegios, mientras él administraba un pequeño alquiler de sonido. Esa constancia inquebrantable les abrió mejores puertas: lograron abrirse paso en el sector de seguros y consultoría. A base de disciplina y estudio constante, se consolidaron como líderes regionales de representación en seguros. Llegaron los frutos de este camino: el terreno propio, la casa construida con sus propias manos y la llegada de su segundo hijo, Bruno Nicolas (2006).
        </>
      ),
    ...
    },
    {
      ...
      content: (
        <>
          Para el año 2010, Juan Carlos y Angélica se encontraban en la cúspide de sus carreras profesionales. Todo parecía perfecto, pero en el corazón de Angélica habitaba un vacío: un sueño de la infancia guardado bajo llave. En 2011, como un entrañable pasatiempo para canalizar su creatividad, comenzó a ofrecer catering para sus amistades. Al reencontrarse con el aroma de la vainilla y el batido de la harina, descubrió lo que le faltaba: era la pequeña Angélica llamándola a ser como su abuela Angela, a hacer feliz a las personas a través de la dulzura. En 2012, junto a su hijo Juan Carlos (hijo) —quien en ese entonces realizaba sus estudios universitarios de negocios en la capital—, plasmaron este viaje en el primer borrador de lo que hoy es "La Nieta de Portella".
        </>
      ),
    ...
    },
    {
      ...
      content: (
        <>
          Lo que operaba como un hobby de cupcakes para amigos demostró tener un potencial imparable. En agosto de 2014, Angélica soltó las pólizas de seguros, se ató el mandil de su infancia y abrió su primer local oficial. Fue cuestión de tiempo para consolidarse como la máxima referente de pastelería fina y de diseñador en toda la región San Martín. Hoy, tras casi 12 años superando crisis y transformaciones, la marca es pionera indiscutible de la repostería artesanal, manteniendo intacta la promesa de paciencia y cariño. Este éxito y crecimiento constante familiar sembró la semilla para expandir su propuesta, dando paso al proyecto de incursionar en el mundo del café de especialidad con la marca de altura <Link to="/categoria/cafe" className="font-semibold text-action-cta hover:underline">DON ANTONIO</Link>, manteniendo siempre viva la tradición y la calidez en cada taza.
        </>
      ),
  ...
  return (
    <div className="bg-primary-bg min-h-screen text-dark-chocolate" id="story-page-root">
      ...
      <section className="relative overflow-hidden py-24 md:py-32 bg-cream-surface border-b border-dark-chocolate/5">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6 relative z-20">
          ...
          >
            Harina en la sangre, coraje en el alma y el dulce aroma de la tradición familiar horneado con amor en Tarapoto.
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-16 bg-cream-surface/40 border-y border-dark-chocolate/5 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6 relative z-20">
          ...
          <blockquote className="font-sans text-xl sm:text-2xl font-bold italic leading-relaxed text-dark-chocolate max-w-2xl mx-auto">
            "La pastelería no es solo mezclar ingredientes; es el arte de volver a ser esa niña que miraba a su abuela cocinar y entender que el ingrediente más importante nunca se compra: se lleva en el alma."
          </blockquote>
