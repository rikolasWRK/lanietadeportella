...
import { openWhatsApp, newsletterMessage } from "../lib/whatsapp";
import {
  Mail,
  Phone,
  MapPin,
...
export default function Footer() {
  ...
  const handleSubscribe = (e: FormEvent) => {
    e.preventDefault();
    if (!email) return;
    // No backend: hand the subscription to the team via WhatsApp so they can
    // add the address to their broadcast list.
    openWhatsApp(newsletterMessage(email));
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-16 pb-16 border-b border-primary-bg/10">
          ...
          <div className="md:col-span-5 space-y-6 text-left">
            ...
            <p className="font-sans text-sm font-light leading-relaxed text-primary-bg/70 max-w-sm">
              Elevando la pastelería artesanal a una experiencia sensorial única
              e inolvidable. Horneamos recuerdos desde 2012 para toda la hermosa
            ...
            <ul className="space-y-3 font-sans text-sm font-light text-primary-bg/80">
              <li>
                <a
                  ...
                  className="hover:text-action-cta transition-colors cursor-pointer"
                >
                  Nosotros
                </a>
              </li>
              ...
              <li>
                <a
                  href="#personalizar"
                  onClick={onSection("personalizar")}
                  className="hover:text-action-cta transition-colors cursor-pointer"
                >
              ...
              <li>
                <Link
                  to="/reclamaciones"
                  className="hover:text-action-cta transition-colors flex items-center gap-1.5"
                >
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-12 gap-8 items-center border-b border-primary-bg/10">
          ...
          <div className="md:col-span-7 space-y-2 text-left">
            ...
            <p className="font-sans text-xs font-light text-primary-bg/60">
              Inscríbete para enterarte de nuestros lanzamientos de temporada,
              recetas caseras secretas y promociones exclusivas de Happy Bakes.
            </p>
          </div>
          ...
          <div className="md:col-span-5 text-left">
            {isSubscribed ? (
              <div className="bg-action-cta/20 border border-action-cta/40 rounded-xl p-4 flex items-center gap-2 text-primary-bg text-sm font-light animate-pulse">
                ...
                <span>
                  ¡Suscrito con éxito! Pronto recibirás novedades dulces en tu
                  buzón.
                </span>
              </div>
            ) : (
        ...
        <div className="pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs font-light text-primary-bg/45 text-center sm:text-left">
          ...
          <div className="flex gap-6 items-center">
            <Link to="/faq" className="hover:text-action-cta transition-colors">
